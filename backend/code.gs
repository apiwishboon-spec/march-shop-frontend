/*************************************************
 * 🔒 SECURE Chromink SHOP BACKEND (GOOGLE APPS SCRIPT)
 * 
 * SECURITY PRINCIPLES:
...
// Store configuration
const STORE_NAME = "Chromink Shop";
const FROM_NAME = "Chromink Shop Orders";
...
Submitted: ${new Date().toISOString()}
    ...
    MailApp.sendEmail({
      ...
      body: emailBody,
      name: "Chromink Website"
    });
    
    // Send confirmation email to customer
    const confirmationSubject = "Thank you for contacting Chromink";
    const confirmationBody = `
Dear ${name},

Thank you for reaching out to Chromink! We've received your message and will get back to you within 24 hours.
...
<head>
<meta charset="UTF-8">
<title>Order Confirmed - Chromink</title>
</head>
...
Thank you for choosing Chromink! 🎨<br>
...
function sendNewsletterWelcome(email) {
  MailApp.sendEmail({
    to: email,
    subject: "Welcome to Chromink!",
    name: FROM_NAME,
    htmlBody: `<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>Welcome to Chromink</title>
</head>
...
<p>
Welcome to the Chromink newsletter. We're excited to have you in our creative circle.
</p>
...
<p style="margin:0 0 10px 0; font-size:13px; color:#777777;">
You're receiving this email because you subscribed to the Chromink newsletter.
</p>
...
<head>
<meta charset="UTF-8">
<title>Order Ready for Pickup - Chromink</title>
</head>
